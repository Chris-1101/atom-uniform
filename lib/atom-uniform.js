...
export default {
  ...
  activate() {
    ...
    this.uniformView.element.addEventListener('blur', this.close.bind(this));
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      atom.commands.add(this.uniformView.element, 'core:confirm', () => {
        this.process();
      }),
      atom.commands.add(this.uniformView.element, 'core:cancel', () => {
        this.close();
      })
    );
  },
